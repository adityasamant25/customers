...
[,console]
----
java -jar target/customers-0.8.0.jar
----
...
[,console]
----
docker run -d --name simply-customers -p 8081:8081 adityasamantlearnings/customers:0.8
----
...
docker rmi adityasamantlearnings/customers:0.8
----
